...
public interface Client extends Subject
{
  ...
  boolean createFeedbackItems(int itemId, String starRating, String feedback,
  ...
  void createReport(int reportFrom, int reportedItemId, int reportedAccountId,
      int reportedItemFeedbackId, String date);
